...
-- Enhanced diagnostic display (make errors more visible)
vim.diagnostic.config({
	virtual_text = true,
	signs = true,
	...
	float = {
		border = "rounded",
		source = "if_many", -- Fixed: was "always"
	},
})

-- Keybinds to navigate errors (fixed deprecated functions)
